    ...
    <div class="w-100 mt-5">
        ...
        <div class="mb-5 text-center">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3">
                ...
                <?php endif; ?>
                <a href="<?php echo htmlspecialchars(app_path('/admin_misiones_premios.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-info btn-lg d-flex align-items-center gap-2"><span>🎯</span>Misiones diarias</a>
