...
// Recargas de juegos: SIEMPRE visible para el revendedor (aunque sea 0, para que sepa dónde ve sus stats de
// recargas — pedido cliente 2026-09-08). Para el dueño (OWNER=0) no aplica (él no compra recargas con saldo).
if ($OWNER > 0 || (int) $k['recargas'] > 0) $cards[] = ['Recargas del mes', (int) $k['recargas'] . ' · $' . number_format((float) $k['recargas_mes'], 2), 'gamepad-2', 'acc', 'tus recargas de juegos'];
