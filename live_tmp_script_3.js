  ...
  const appBasePath = "";
  const rememberLastPurchaseIdentifierEnabled = false;
  const defaultOrderEmail = "";
  let defaultOrderUserIdentifier = "";
  let defaultPaymentPhone = "";
  const paymentMethodsByCurrency = {"BS":[{"id":3,"nombre":"Pago mobil","datos":"Banco Nacional de Credito\r\n✅🪪: 24107382\r\n✅📲: 04248788403\r\n✅🏦: 0191 - BNC","image_path":"assets/img/payment-methods/method_11adb382eb4df51a.png","qr_image_path":"assets/img/payment-methods/qr_9af5f94970b5be66.png","corner_image_path":"","moneda_id":2,"moneda_nombre":"Bolivares","moneda_clave":"BS","referencia_digitos":5,"descuento_porcentaje":0}]};
  const binancePayCheckoutEnabled = true;
  const paypalPayCheckoutEnabled = true;
  const paymentMethodDiscountsEnabled = true;
  const binancePayDiscountPercentage = 3;
  const accountSaleFeatureEnabled = true;
  const binancePayButtonLabel = 'Binance Pay';
  const binancePayImageUrl = "/uploads/store/binance-pay-method-20260518213333-8bbfd08b.png";
  const binancePayCornerImageUrl = "";
  const paypalPayButtonLabel = 'PayPal';
  const paypalPayImageUrl = "/uploads/store/paypal-method-20260519230120-2c51bffb.jpg";
  const paypalPayCornerImageUrl = "";
  const paypalPayQrImageUrl = "";
  const paypalSupportedCurrencies = ["AUD","BRL","CAD","CZK","DKK","EUR","HKD","HUF","ILS","JPY","MXN","MYR","NOK","NZD","PHP","PLN","GBP","SGD","SEK","CHF","TWD","THB","USD"];
  const paymentSupportWhatsappBase = "https://wa.me/584248788403";
  const winPointsState = {"enabled":true,"loggedIn":false,"name":"RE Coins","iconUrl":"/uploads/store/win-points-icon-20260409213843-1abd96e3.png","paymentImageUrl":"/uploads/store/win-points-payment-method-20260518210645-f2b1fd0d.png","paymentCornerImageUrl":"","notificationLogoUrl":"/uploads/store/store-logo-20260411113021-ea74b796.jpg","notificationPosition":"top-center","guestMessage":"Registrate o Inicia Sesion para acceder al sistema de Premios por recarga","balance":0};
  const gameUsesCatalogApi = true;
  const paymentHeaderMinimalEnabled = false;
  const packageFeatureIconSvgMap = {"sparkles":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M8 0l1.1 3.3L12.4 4.4 9.7 6.3 10.7 9.6 8 7.7 5.3 9.6 6.3 6.3 3.6 4.4 6.9 3.3 8 0Zm-5.2 9.2.6 1.8 1.8.6-1.8.6-.6 1.8-.6-1.8-1.8-.6 1.8-.6.6-1.8Zm10.4 0 .6 1.8 1.8.6-1.8.6-.6 1.8-.6-1.8-1.8-.6 1.8-.6.6-1.8Z\"/></svg>","diamond":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M4.1 1h7.8l3 3.6L8 15 1.1 4.6 4.1 1Zm1 1.5L3.1 5h2.7l1.1-2.5H5.1Zm5.8 0H9.1L10.2 5h2.7l-2-2.5ZM8 3.2 7.2 5h1.6L8 3.2ZM6.4 6.2 8 11.6l1.6-5.4H6.4Z\"/></svg>","lightning":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M9.5.5 3 8h3.6L5.5 15.5 13 7.9H9.4L9.5.5Z\"/></svg>","shield":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M8 0 2.5 2v4.8c0 3.6 2.2 6.8 5.5 8.2 3.3-1.4 5.5-4.6 5.5-8.2V2L8 0Zm0 1.6 4 1.4v3.8c0 2.7-1.5 5.2-4 6.4-2.5-1.2-4-3.7-4-6.4V3l4-1.4Z\"/></svg>","gift":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M15 4h-2.1c.4-.4.6-.9.6-1.5C13.5 1.1 12.4 0 11 0 9.8 0 8.8.7 8 1.8 7.2.7 6.2 0 5 0 3.6 0 2.5 1.1 2.5 2.5c0 .6.2 1.1.6 1.5H1v3h1v8h12V7h1V4ZM9 2.5c.5-.8 1.2-1.2 2-1.2.6 0 1.1.5 1.1 1.2S11.6 3.7 11 3.7H9V2.5Zm-4 0c.8 0 1.5.4 2 1.2v1.2H5c-.6 0-1.1-.5-1.1-1.2S4.4 2.5 5 2.5ZM2.3 5.3h5v1.4h-5V5.3Zm6.4 0h5v1.4h-5V5.3ZM7.3 8v5.7H3.4V8h3.9Zm1.4 0h3.9v5.7H8.7V8Z\"/></svg>","controller":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M4 4.5C2.1 4.5.5 6 .5 7.9c0 1 .4 1.9 1.1 2.6l1.8 1.8c.6.6 1.4.9 2.2.9.9 0 1.7-.4 2.3-1.1l.1-.2.1.2c.6.7 1.4 1.1 2.3 1.1.8 0 1.6-.3 2.2-.9l1.8-1.8c.7-.7 1.1-1.6 1.1-2.6C15.5 6 13.9 4.5 12 4.5c-1.1 0-2.2.5-2.9 1.3L8 7 6.9 5.8C6.2 5 5.1 4.5 4 4.5ZM4.5 7h1v1h1v1h-1v1h-1V9h-1V8h1V7Zm6.8.7a.8.8 0 1 1 0 1.6.8.8 0 0 1 0-1.6Zm1.9-1.7a.8.8 0 1 1 0 1.6.8.8 0 0 1 0-1.6Z\"/></svg>","trophy":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M4 1h8v2h2v1a4 4 0 0 1-3.5 4A4.5 4.5 0 0 1 8.8 10v1.5h2V13H5.2v-1.5h2V10A4.5 4.5 0 0 1 5.5 8 4 4 0 0 1 2 4V3h2V1Zm1.5 1.5v3A3 3 0 0 0 8 8.5a3 3 0 0 0 2.5-3v-3h-5ZM3.5 4.5c0 1 .7 1.9 1.6 2.2-.1-.4-.1-.8-.1-1.2v-.9H3.5v-.1Zm9.5 0v.9c0 .4 0 .8-.1 1.2.9-.3 1.6-1.2 1.6-2.2v.1H13Z\"/></svg>","rocket":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M9.7.5c1.8.1 3.4.8 4.8 2.1 1.3 1.4 2 3 2.1 4.8l-3.4 1.7-1.5-1.5-2.3 2.3.6 2.7-2.1 2.1-.9-2.4-2.4-.9 2.1-2.1 2.7.6 2.3-2.3-1.5-1.5L9.7.5Zm2.6 3.1a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4ZM2.2 11.3c.8 0 1.5.7 1.5 1.5 0 1.2-1.9 2.7-3.2 3.2.5-1.3 2-3.2 3.2-3.2Z\"/></svg>","star":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"m8 0 2.2 4.6 5 .7-3.6 3.6.9 5.1L8 11.6 3.5 14l.9-5.1L.8 5.3l5-.7L8 0Z\"/></svg>","layers":"<svg viewBox=\"0 0 16 16\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M8 1 1 4.5 8 8l7-3.5L8 1Zm-7 6 7 3.5L15 7v2L8 12.5 1 9V7Zm0 4 7 3.5 7-3.5v2L8 16 1 13v-2Z\"/></svg>","best_seller":"<span aria-hidden=\"true\" style=\"display:inline-block;font-size:1.05rem;line-height:1;\">🔥</span>","limited":"<span aria-hidden=\"true\" style=\"display:inline-block;font-size:1.05rem;line-height:1;\">⏳</span>","recommended":"<span aria-hidden=\"true\" style=\"display:inline-block;font-size:1.05rem;line-height:1;\">👑</span>"};
  ...
  const playerVerificationConfig = null;
  ...
  const paymentWindowThemeEnabled = false;
  const paymentSendingOrderContent = {
    title: "Enviando orden...",
    message: "Estamos registrando tu comprobante y procesando la orden según la moneda del pedido. No cierres esta ventana."  };
  const paymentDifferenceFeatureEnabled = false;
  const gameEntryWindowEnabled = false;
  const currentGameName = "BloodStrike";
  const paymentSuccessContent = {
    title: "Pago exitoso",
    extraMessage: ""  };
  let paymentDifferenceCreditState = null;
  ...
  if (packCards2.length) {
    const requestedPackCard = findPackCardById(0);
      ...
      triggerAccountSaleBuyFlow(accountGalleryModalBuy);
              ...
              applyCouponButton.addEventListener('click', function() {
                ...
                fetch(buildAppUrl('/api/validar_cupon.php'), {
                  method: 'POST',
                  headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                  body: `code=${encodeURIComponent(cupon)}&pack_price=${encodeURIComponent(precioNumerico)}&currency=${encodeURIComponent(pack.moneda || '')}&game_id=${encodeURIComponent("24")}`
                })
                .then(res => res.json())
                .then(data => {
